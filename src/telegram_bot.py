                ...
                try:
                    ...
                    if new_level == current_level:
                        ...
                        try:
                            ...
                            # Выводим все 5 уровней логирования для проверки
                            logger.debug("🔍 DEBUG: Отладочное сообщение")
                            logger.info("ℹ️ INFO: Информационное сообщение")
                            logger.warning("⚠️ WARNING: Предупреждение")
